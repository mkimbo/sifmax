...
function Footer({}: Props) {
  return (
    <footer className="bg-muted/30 border-t px-2">
      <div className="container mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Sifmax Beauty Parlour is Dar es Salaam's premier 24-hour beauty
              destination offering exceptional services in a luxurious setting.
            </p>
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Sifmax Beauty Parlour. All rights
            reserved.
          </p>
          <div className="flex gap-4">
            <Link
