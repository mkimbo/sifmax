      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            designed to pamper and rejuvenate you from head to toe.
          </p>
        </div>
          ...
          <div className="group bg-gradient-to-br from-primary/20 to-primary/5 rounded-lg shadow-sm overflow-hidden border border-primary/30 hover:border-primary/50 transition-colors">
            <div className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                designed to give you the ultimate beauty experience at
                exceptional value.
              </p>
              <div className="bg-background/80 p-4 rounded-lg mb-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start text-sm">
                    ...
                    <span>
                      <strong>Weekday Special:</strong> 20% off all services
                      Monday-Thursday
                    </span>
                  </li>
                  <li className="flex items-start text-sm">
                    <ChevronDown className="h-4 w-4 text-primary mr-2 mt-0.5" />
                    <span>
                      <strong>Package Deal:</strong> Book any 3 services and get
                      15% discount
                    </span>
                  </li>
                  <li className="flex items-start text-sm">
                    <ChevronDown className="h-4 w-4 text-primary mr-2 mt-0.5" />
                    <span>
                      <strong>First-Time Client:</strong> Free mini facial with
                      any service
                    </span>
                  </li>
                </ul>
              ...
              <Modal>
                ...
                <ModalBody>
                  <ModalContent>
                    <h3 className="text-2xl font-bold mb-2 md:mb-6">
                    ...
                    >
                      <div className="border border-primary/30 bg-primary/5 rounded-lg p-4">
                        ...
                        <p className="mb-2">
                          Enjoy 20% off all services Monday through Thursday.
                        </p>
                        <p className="text-sm text-muted-foreground">
                          Valid for all services. Cannot be combined with other
                          offers.
                        </p>
                      </div>
                      <div className="border border-primary/30 bg-primary/5 rounded-lg p-4">
                        ...
                        <p className="mb-2">
                          Book any 3 services and receive a 15% discount on your
                          total.
                        </p>
                        <p className="text-sm text-muted-foreground">
                          Services must be booked for the same day. Advance
                          booking required.
                        </p>
                      </div>
                      <div className="border border-primary/30 bg-primary/5 rounded-lg p-4">
                        ...
                        <p className="mb-2">
                          New clients receive a complimentary mini facial with
                          any service.
                        </p>
                        <p className="text-sm text-muted-foreground">
                          First visit only. Please mention this offer when
                          booking.
                        </p>
                      </div>
                      <div className="border border-primary/30 bg-primary/5 rounded-lg p-4">
                        ...
                        <p className="mb-2">
                          Refer a friend and both receive 10% off your next
                          visit.
                        </p>
                        <p className="text-sm text-muted-foreground">
                          Friend must be a new client and mention your name when
                          booking.
                        </p>
                      </div>
                    </div>
