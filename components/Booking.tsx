        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground mb-6">
              Ready to experience the Sifmax difference? Book your appointment
              today and let our expert team take care of all your beauty needs.
            </p>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Beauty services available around the clock to fit your
                      schedule
                    </p>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Only the highest quality beauty products used in all
                      services
                    </p>
                  </div>
                </li>
