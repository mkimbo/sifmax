...
const VideoThumbnailComponent: React.FC<{ src: string; alt: string }> = ({
  src,
  alt,
}) => {
...
export function GallerySection() {
  ...
  const activeCategory = galleryData.find(
      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Take a virtual tour of our luxurious salon and see the beautiful
            environment where we create stunning transformations.
          </p>
        </div>
