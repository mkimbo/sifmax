...
import parlour1 from "../../assets/images/sifmax9.png";
import parlour4 from "../../assets/images/sifmax8.png";
import parlour5 from "../../assets/images/sifmax5.png";
...
// Update the Frame interface to include type
interface Frame {
  id: number;
  type: "video" | "image"; // Add type property
  src: string | StaticImageData; // Rename video to src
...
const initialFrames: Frame[] = [
  ...
  {
    id: 2,
    type: "image", // Change this one to an image
    src: parlour1,
...
// const toggleMediaType = (id: number) => {
//   setFrames(
//     frames.map((frame) => {
//       if (frame.id === id) {
//         return {
//           ...frame,
//           type: frame.type === "video" ? "image" : "video",
//           src:
//             frame.type === "video" && frame.src.endsWith(".mp4")
//               ? "https://static.cdn-luma.com/files/981e483f71aa764b/placeholder-image.jpg"
//               : frame.src,
//         }
//       }
//       return frame
      ...
      >
        {frames.map((frame) => {
          ...
          return (
            ...
            >
              <FrameComponent
                type={frame.type} // Add type property
                src={frame.src} // Rename video to src
                width="100%"
                height="100%"
