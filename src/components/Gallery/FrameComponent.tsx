...
// Update the props interface to support both video and image types
interface FrameComponentProps {
  type: "video" | "image"; // Add type property
  src: string | StaticImageData; // Rename video to src for generic media source
  width: number | string;
...
export function FrameComponent({
  ...
  useEffect(() => {
    if (type === "video") {
      // Only apply autoplay logic to videos
      if (autoplayMode === "all") {
