...
import logo from "../../assets/icons/sifmax-logo.png";
    ...
    <div className={classes.Summary}>
      <div className={classes.Block}>
        ...
        <p className={classes.Content}>
          ...
          Duis fermentum massa ac metus suscipit tincidunt. Praesent felis
          felis, pretium sit amet vehicula at, posuere at mauris.
        </p>
      </div>
